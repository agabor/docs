...
The Mongo requirements for MSG Server are:
...
When using MongoDB with your MSG app, you need to manage your indexes yourself. You will also need to size up your database as your data grows.
...
The Postgres requirements for MSG Server are:
...
When using Postgres with your MSG app, you need to manage your indexes yourself.
